This is a modified version of CarveMe being used for the express purpose of model reconstruction by Architect.  The list of modifications are given in ARCHITECT_modifications.out in this folder.
