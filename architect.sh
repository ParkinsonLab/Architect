...
python ${ARCHITECT}/architect/construct_metabolic_model.py --project_name $PROJECT --output_dir $OUTPUT_DIR --arguments_file $INPUT_FILE --project_name $PROJECT --architect_path $ARCHITECT